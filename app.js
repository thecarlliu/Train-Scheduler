...
$("#submitBtn").on("click", function() {
	...
	createTrain(nameInput, destinationInput, trainTimeInput, frequencyInput, inputList);
...
function createTrain(name, destination, trainTime, frequency, inputs) {
	//doTheMath(startDate);
	//create row of info
	inputs = [];
	inputs.push(name, destination, trainTime, frequency);
